 ...
 * Created by Gideon on 10/18/2016.
 */
...
public final class QueryUtils {
     ...
     * directly from the class name QueryUtils (and an ibject instance of QueryUtils is not needed.
     */
    private QueryUtils() {
    }
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        //Create an empty ArrayList trhat we can start adding earthquakes to
        ArrayList<Earthquake> earthquakes = new ArrayList<>();

        // Try to parse SAMPLE_JASON_RESPONSE. If there's a problem with the way JSON
        //is formatted, a JSONException exception object will be thrown.
        //Catch the exception so that app doesn't crash, and print the error message to the logs.
        try {

            // Parse the responce given by the SAMPLE_JSON_RESPONSE string and
            ...
            //catch the exception herre, to the app doesn't crash. Print a log message
            //with the message from the exception
            Log.e("QueryUtils","Problem parsing the earthquake JSON results",e);
        }

        //Returen the list of earthquakes
        return earthquakes;
